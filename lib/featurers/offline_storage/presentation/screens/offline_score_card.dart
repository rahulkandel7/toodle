...
class OfflineScoreCard extends ConsumerStatefulWidget {
  static const String routeName = '/offline-quiz-submit';
  const OfflineScoreCard({super.key});

  @override
  OfflineScoreCardState createState() => OfflineScoreCardState();
}

class OfflineScoreCardState extends ConsumerState<OfflineScoreCard> {
  String username = "";
  _getUserInfo() async {
    ...
    return WillPopScope(
      onWillPop: () async {
        Navigator.of(context)
            .popUntil(ModalRoute.withName(DownloadedExamScreens.routeName));
        return true;
      },
      child: Scaffold(
        appBar: AppBar(
          ...
          leading: IconButton(
            onPressed: () {
              Navigator.of(context)
                  .pushReplacementNamed(DownloadedExamScreens.routeName);
            },
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Center(
                child: Text('View Paper will available in online mode'),
              ),
            ],
          ),
        ),
